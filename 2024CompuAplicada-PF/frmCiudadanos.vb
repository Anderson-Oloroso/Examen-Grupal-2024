...
Imports iTextSharp.text
    ...
    Private Sub ciudadanos()
        ...
        Try
            ...
            While buscar.Read
                dgvTotal.Rows.Add(buscar!cod_tipocuenta, buscar!nombre, buscar!descripcion)
            End While
    ...
    Private Sub frmCiudadanos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ciudadanos()
    End Sub
